# 1 "/home/studio/Prova_casa/solution1/.autopilot/db/zhang_convolution_quant.pragma.1.c"
# 1 "/home/studio/Prova_casa/solution1/.autopilot/db/zhang_convolution_quant.pragma.1.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 1 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_ssdm_op.h" 1
# 296 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "/home/studio/Prova_casa/solution1/.autopilot/db/zhang_convolution_quant.pragma.1.c" 2
# 1 "Prova_casa/src/zhang_convolution_quant.c"
# 1 "Prova_casa/src/zhang_convolution_quant.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "Prova_casa/src/zhang_convolution_quant.c" 2
# 1 "Prova_casa/src/net_config.h" 1
# 66 "Prova_casa/src/net_config.h"
static int possible_kernel_sizes[2] = { 1, 3 };
static int max_n_weights_per_size[2] = { 10000, 36864 };
static int max_out_ch_per_size[2] = { 100, 64 };
static int max_in_ch_per_size[2] = { 100, 64 };
# 2 "Prova_casa/src/zhang_convolution_quant.c" 2
# 1 "Prova_casa/src/net_types.h" 1
# 1 "/media/dati/dante/Xilinx/Vivado/2017.3/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdint.h" 1 3
# 33 "/media/dati/dante/Xilinx/Vivado/2017.3/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdint.h" 3
...
# 34 "/media/dati/dante/Xilinx/Vivado/2017.3/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdint.h" 2 3
# 2 "Prova_casa/src/net_types.h" 2
# 1 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/ap_cint.h" 1
# 62 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/ap_cint.h"
# 1 "/usr/include/string.h" 1 3 4
# 32 "/usr/include/string.h" 3 4
# 1 "/media/dati/dante/Xilinx/Vivado/2017.3/lnx64/tools/clang/bin/../lib/clang/3.1/include/stddef.h" 1 3 4
# 31 "/media/dati/dante/Xilinx/Vivado/2017.3/lnx64/tools/clang/bin/../lib/clang/3.1/include/stddef.h" 3 4
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 63 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/ap_cint.h" 2
...
# 1 "/media/dati/dante/Xilinx/Vivado/2017.3/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdarg.h" 1 3 4
# 30 "/media/dati/dante/Xilinx/Vivado/2017.3/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdarg.h" 3 4
typedef __builtin_va_list va_list;
# 48 "/media/dati/dante/Xilinx/Vivado/2017.3/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdarg.h" 3 4
...
# 64 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/ap_cint.h" 2
# 77 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/ap_cint.h"
# 1 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_apint.h" 1
# 57 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_apint.h"
# 1 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_dt.h" 1
# 97 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_dt.h"
# 1 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_dt.def" 1
...
# 98 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_dt.h" 2
# 1 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_dt_ext.def" 1
...
# 99 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_dt.h" 2
# 108 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_dt.h"
# 1 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_dt.def" 1
...
# 109 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_dt.h" 2
# 1 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_dt_ext.def" 1
...
# 110 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_dt.h" 2
# 131 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_dt.h"
typedef int __attribute__ ((bitwidth(64))) int64;
typedef unsigned int __attribute__ ((bitwidth(64))) uint64;
# 58 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_apint.h" 2
# 1 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_ssdm_bits.h" 1
# 59 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/etc/autopilot_apint.h" 2
# 78 "/media/dati/dante/Xilinx/Vivado/2017.3/common/technology/autopilot/ap_cint.h" 2
# 3 "Prova_casa/src/net_types.h" 2
# 21 "Prova_casa/src/net_types.h"
typedef float tensor_data_t;
typedef int10 int_input;
typedef int10 int_weight;
typedef int27 int_output;
...
# 3 "Prova_casa/src/zhang_convolution_quant.c" 2
# 1 "Prova_casa/src/zhang_convolution_quant.h" 1
...
void zhang_cnn(
  ...
  int right_shift );
# 4 "Prova_casa/src/zhang_convolution_quant.c" 2
# 25 "Prova_casa/src/zhang_convolution_quant.c"
...
void set_out_buffer_to_0(
  int_output outputfm[28][37][27]){_ssdm_SpecArrayDimSize(outputfm,28);
#pragma INLINE
...
void set_in_wh_buffers_to_0(
  ...
  int_weight weightsbuf[28][3][3][3],
  int_input inputfm[3][(37 -1)*1 +3][(27 -1)*1 +3]){_ssdm_SpecArrayDimSize(inputfm,3);_ssdm_SpecArrayDimSize(weightsbuf,28);
_ssdm_InlineSelf(0, "");
...
_ssdm_Unroll(0,0,0, "");
 ...
 for(int r = 0; r < (37 -1)*1 +3; r++){
  for(int c = 0; c < (27 -1)*1 +3; c++){
_ssdm_op_SpecPipeline(1, 1, 1, 0, "");
 for(int j = 0; j < 3; j++){
_ssdm_Unroll(0,0,0, "");
 inputfm[j][r][c] = 0;
...
void read_input(uint_output *input, layer_config curr_layer, int ti, int row, int col, int_input inputfm[3][(37 -1)*1 +3][(27 -1)*1 +3],
    int input_offset){_ssdm_SpecArrayDimSize(inputfm,3);

 int stride = ti * curr_layer.in_w * curr_layer.in_h + (row*curr_layer.str_h) * curr_layer.in_w + (col*curr_layer.str_w);
 int n_rows = ((((37 -1)*curr_layer.str_h + curr_layer.ker_h) < (curr_layer.in_h)) ? ((37 -1)*curr_layer.str_h + curr_layer.ker_h) : (curr_layer.in_h));
 int n_cols = ((((27 -1)*curr_layer.str_w + curr_layer.ker_w) < (curr_layer.in_w)) ? ((27 -1)*curr_layer.str_w + curr_layer.ker_w) : (curr_layer.in_w));
 int n_depth = (((3) < (curr_layer.in_ch)) ? (3) : (curr_layer.in_ch));
 ...
 readIn: for(int itr = 0, i = 0, j = 0, jj = 0;
   ...
   itr++,j++) {
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
_ssdm_op_SpecLoopTripCount(0, 3*(27-1)*1+3*(37-1)*1+3, 0, "");
...
void read_weights(uint_output *weights, layer_config curr_layer, int to, int ti, int_weight weightsbuf[28][3][3][3],
  int weights_offset){_ssdm_SpecArrayDimSize(weightsbuf,28);
 ...
 int n_depth_o = (((28) < (curr_layer.out_ch)) ? (28) : (curr_layer.out_ch));
 int n_depth_i = (((3) < (curr_layer.in_ch)) ? (3) : (curr_layer.in_ch));
...
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
_ssdm_op_SpecLoopTripCount(0, 28*3*3*3, 0, "");
...
void convolve(layer_config curr_layer, int_output outputfm[28][37][27],
    int_output partial_outputfm[28][37][27],
    int_weight weightsbuf[28][3][3][3],
    int_input inputfm[3][(37 -1)*1 +3][(27 -1)*1 +3],
    int row, int col, int to, int ti)
{_ssdm_SpecArrayDimSize(inputfm,3);_ssdm_SpecArrayDimSize(outputfm,28);_ssdm_SpecArrayDimSize(weightsbuf,28);_ssdm_SpecArrayDimSize(partial_outputfm,28);

 ker_h:for(int i =0; i < curr_layer.ker_h; i ++) {
_ssdm_op_SpecLoopTripCount(0, 3, 1, "");
 ker_w:for(int j =0; j < curr_layer.ker_w; j ++) {
_ssdm_op_SpecLoopTripCount(0, 3, 1, "");
 tr_loop:for (int trr=0 ; row + trr < (((row+37) < (curr_layer.out_h)) ? (row+37) : (curr_layer.out_h)); trr++){
_ssdm_op_SpecLoopTripCount(0, 37, 18, "");
 int r_index = curr_layer.str_h*trr;
    tc_loop:for (int tcc=0 ; col + tcc < (((col+27) < (curr_layer.out_w)) ? (col+27) : (curr_layer.out_w)); tcc++){
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
_ssdm_op_SpecLoopTripCount(0, 27, 13, "");

 int c_index = curr_layer.str_w*tcc;
     too_loop:for(int too=0; too < 28; too++){
_ssdm_Unroll(0,0,0, "");
_ssdm_SpecDependence( partial_outputfm, 0, 0, -1, 0, 1);

 int19 out_value_tot = 0;

      tii_loop_mul:for(int tii=0; tii < 3; tii ++){
_ssdm_Unroll(0,0,0, "");
...
void write_output(layer_config curr_layer, volatile uint_output *out, int to, int row, int col, int_output outputfm[28][37][27],
  int input_offset,int weights_offset, int output_offset,int_internal quantized_multiplier,int_internal right_shift){_ssdm_SpecArrayDimSize(outputfm,28);
 ...
 int n_rows = (((37) < (curr_layer.out_h)) ? (37) : (curr_layer.out_h));
 int n_cols = (((27) < (curr_layer.out_w)) ? (27) : (curr_layer.out_w));
 int n_depth_o = (((28) < (curr_layer.out_ch)) ? (28) : (curr_layer.out_ch));
...
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
_ssdm_op_SpecLoopTripCount(0, 28*37*27, 0, "");
 ...
 if(j == n_cols) {
  ...
  out[stride + ii_index + i_index + j] = (uint_output) (((0) > ((((256) < ((RoundingDivideByPOT(saturated_out, right_shift) + output_offset))) ? (256) : ((RoundingDivideByPOT(saturated_out, right_shift) + output_offset))))) ? (0) : ((((256) < ((RoundingDivideByPOT(saturated_out, right_shift) + output_offset))) ? (256) : ((RoundingDivideByPOT(saturated_out, right_shift) + output_offset)))));
    }
}

void read_in_wh( uint_output *weights, uint_output *image, layer_config curr_layer, int to, int ti, int row, int col,
  int_input inputfm[3][(37 -1)*1 +3][(27 -1)*1 +3], int_weight weightsbuf[28][3][3][3], int_output partial_outputfm[28][37][27],
  int input_offset, int weights_offset){_ssdm_SpecArrayDimSize(inputfm,3);_ssdm_SpecArrayDimSize(weightsbuf,28);_ssdm_SpecArrayDimSize(partial_outputfm,28);
...
void dataflow_in_channels(uint_output *weights, uint_output *image, layer_config curr_layer,
  ...
  int_output partial_outputfm[28][37][27], int_output outputfm[28][37][27],
  int_input inputfm[3][(37 -1)*1 +3][(27 -1)*1 +3], int_weight weightsbuf[28][3][3][3],
  int input_offset,int weights_offset,int output_offset,
  int_internal quantized_multiplier,int_internal right_shift){_ssdm_SpecArrayDimSize(inputfm,3);_ssdm_SpecArrayDimSize(outputfm,28);_ssdm_SpecArrayDimSize(weightsbuf,28);_ssdm_SpecArrayDimSize(partial_outputfm,28);
...
void dataflow_out_channels(uint_output *weights, uint_output *image, layer_config curr_layer,
  ...
  int_output outputfm[28][37][27], int_output partial_outputfm[28][37][27],
  int_input inputfm[3][(37 -1)*1 +3][(27 -1)*1 +3], int_weight weightsbuf[28][3][3][3],
  int input_offset,int weights_offset,int output_offset,
  int_internal quantized_multiplier,int_internal right_shift){_ssdm_SpecArrayDimSize(inputfm,3);_ssdm_SpecArrayDimSize(outputfm,28);_ssdm_SpecArrayDimSize(weightsbuf,28);_ssdm_SpecArrayDimSize(partial_outputfm,28);
...
_ssdm_op_SpecDataflowPipeline(-1, "");
 ...
 ti_loop:for(int ti = 0; ti < curr_layer.in_ch; ti += 3){
...
_ssdm_op_SpecInterface(image, "m_axi", 0, 0, "", 0, 102400, "gmem", "slave", "", 16, 16, 16, 16, "", "");
_ssdm_op_SpecInterface(weights, "m_axi", 0, 0, "", 0, 102400, "gmem", "slave", "", 16, 16, 16, 16, "", "");
_ssdm_op_SpecInterface(out, "m_axi", 0, 0, "", 0, 102400, "gmem", "slave", "", 16, 16, 16, 16, "", "");

_ssdm_op_SpecInterface(image, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(weights, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(out, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(&curr_layer_in, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(input_offset, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(weights_offset, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(output_offset, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(quantized_multiplier, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(right_shift, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(0, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");

static int_output outputfm[28][37][27] = {0};
static int_weight weightsbuf[28][3][3][3] = {0};
static int_input inputfm[3][(37 -1)*1 +3][(27 -1)*1 +3] = {0};
static int_output partial_outputfm[28][37][27] = {0};

_ssdm_SpecArrayPartition( partial_outputfm, 1, "complete", 0, "");
_ssdm_SpecArrayPartition( outputfm, 1, "complete", 0, "");
_ssdm_SpecArrayPartition( weightsbuf, 1, "complete", 0, "");
_ssdm_SpecArrayPartition( weightsbuf, 2, "complete", 0, "");
_ssdm_SpecArrayPartition( inputfm, 1, "complete", 0, "");



_ssdm_op_SpecResource(partial_outputfm, "", "RAM_2P_BRAM", "", -1, "", "", "", "", "");

layer_config curr_layer = curr_layer_in;
rounding = (right_shift < 1) ? 0 : (1 << (right_shift - 1));

row_loop:for(int row = 0; row < curr_layer.out_h; row += 37){
_ssdm_op_SpecLoopTripCount(24, 30, 27, "");

 col_loop:for(int col = 0; col < curr_layer.out_w; col += 27){
_ssdm_op_SpecLoopTripCount(24, 30, 27, "");
 to_loop:for(int to = 0; to < curr_layer.out_ch; to += 28){
_ssdm_op_SpecLoopTripCount(64, 100, 82, "");
