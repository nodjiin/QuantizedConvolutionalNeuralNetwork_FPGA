...
void dataflow_out_chanbIp::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void dataflow_out_chanbIp::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void dataflow_out_chanbIp::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void dataflow_out_chanbIp::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
