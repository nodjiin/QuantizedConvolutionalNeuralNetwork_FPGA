...
#ifndef __zhang_cnn_mac_mulbkb__HH__
#define __zhang_cnn_mac_mulbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(zhang_cnn_mac_mulbkb) {
    ...
    SC_CTOR(zhang_cnn_mac_mulbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
