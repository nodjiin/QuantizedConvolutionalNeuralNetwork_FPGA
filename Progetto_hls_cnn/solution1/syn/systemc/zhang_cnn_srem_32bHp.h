...
#ifndef __zhang_cnn_srem_32bHp__HH__
#define __zhang_cnn_srem_32bHp__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(zhang_cnn_srem_32bHp) {
    ...
    SC_CTOR(zhang_cnn_srem_32bHp):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
