...
#ifndef __zhang_cnn_mul_96neOg__HH__
#define __zhang_cnn_mul_96neOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(zhang_cnn_mul_96neOg) {
    ...
    SC_CTOR(zhang_cnn_mul_96neOg):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
