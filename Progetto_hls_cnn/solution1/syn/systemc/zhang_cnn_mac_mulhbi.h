...
#ifndef __zhang_cnn_mac_mulhbi__HH__
#define __zhang_cnn_mac_mulhbi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(zhang_cnn_mac_mulhbi) {
    ...
    SC_CTOR(zhang_cnn_mac_mulhbi):  simcore_mac_4_U ("simcore_mac_4_U") {
