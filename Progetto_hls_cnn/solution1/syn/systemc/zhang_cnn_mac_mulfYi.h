...
#ifndef __zhang_cnn_mac_mulfYi__HH__
#define __zhang_cnn_mac_mulfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(zhang_cnn_mac_mulfYi) {
    ...
    SC_CTOR(zhang_cnn_mac_mulfYi):  simcore_mac_2_U ("simcore_mac_2_U") {
