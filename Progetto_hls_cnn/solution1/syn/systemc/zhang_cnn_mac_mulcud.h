...
#ifndef __zhang_cnn_mac_mulcud__HH__
#define __zhang_cnn_mac_mulcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(zhang_cnn_mac_mulcud) {
    ...
    SC_CTOR(zhang_cnn_mac_mulcud):  simcore_mac_1_U ("simcore_mac_1_U") {
