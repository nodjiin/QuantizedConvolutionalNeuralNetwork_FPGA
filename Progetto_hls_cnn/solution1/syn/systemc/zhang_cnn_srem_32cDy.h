...
#ifndef __zhang_cnn_srem_32cDy__HH__
#define __zhang_cnn_srem_32cDy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(zhang_cnn_srem_32cDy) {
    ...
    SC_CTOR(zhang_cnn_srem_32cDy):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
