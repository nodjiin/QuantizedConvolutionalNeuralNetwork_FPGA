...
#ifndef __zhang_cnn_mul_64ndEe__HH__
#define __zhang_cnn_mul_64ndEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(zhang_cnn_mul_64ndEe) {
    ...
    SC_CTOR(zhang_cnn_mul_64ndEe):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
