#pragma line 1 "/home/studio/Prova_casa/testbench/tensor.c"
...
#pragma empty_line
#pragma line 7 "/home/studio/Prova_casa/testbench/tensor.c" 2
...
#pragma empty_line
#pragma line 8 "/home/studio/Prova_casa/testbench/tensor.c" 2
#pragma empty_line
...
#pragma line 10 "/home/studio/Prova_casa/testbench/tensor.c" 2
#pragma empty_line
void free_tensor(tensor *t)
{
 if(t != ((void *)0))
...
#pragma empty_line
#pragma empty_line
 int d_bound = t.data == ((void *)0) ? 0 : t.d;
 int w_bound = t.data == ((void *)0) ? 0 : t.w;
 int h_bound = t.data == ((void *)0) ? 0 : t.h;
#pragma empty_line
...
#pragma empty_line
   for(w = 0; w < w_bound; w++)
   {
    printf( "%.19f ", t.data[d*t.h*t.w + h*t.w + w]);
   }
   printf("\n");
  }
  printf("\n");
...
{
 return ((tensor_data_t)rand()/(tensor_data_t)2147483647) * (max - min) + min;
}
#pragma empty_line
...
#pragma empty_line
 for(d_out = 0; d_out < out_vol.d; d_out++)
 {
  for(h_out = 0; h_out < out_vol.h; h_out++)
  {
   ...
   {
    int out_i = d_out*out_vol.h*out_vol.w + h_out*out_vol.w + w_out;
...
#pragma empty_line
    for(h_ker = 0; h_ker < ker_height; h_ker++)
    {
     ...
     {
      int in_i = d_out*input.h*input.w + (h_out*stride_h + h_ker)*input.w + w_out*stride_w + w_ker;
...
#pragma line 291 "/home/studio/Prova_casa/testbench/tensor.c"
void concat_tensors(int concat_dim, int n_tensors, tensor *to_concat, tensor *out)
{
 int i, d, h, w;
 int d_offset = 0;
...
#pragma empty_line
  if(concat_dim == 1) d_offset += curr.d;
  else if(concat_dim == 2) h_offset += curr.h;
  else if(concat_dim == 3) w_offset += curr.w;
  else
  {
