...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 image_r W 0x0 "Data signal of image_r" {{0 32 image_r W 0 "Bit 31 to 0 Data signal of image_r"}}} {0x18 weights W 0x0 "Data signal of weights" {{0 32 weights W 0 "Bit 31 to 0 Data signal of weights"}}} {0x20 out_r W 0x0 "Data signal of out_r" {{0 32 out_r W 0 "Bit 31 to 0 Data signal of out_r"}}} {0x28 curr_layer_in_n_layer W 0x0 "Data signal of curr_layer_in_n_layer" {{0 32 curr_layer_in_n_layer W 0 "Bit 31 to 0 Data signal of curr_layer_in_n_layer"}}} {0x30 curr_layer_in_in_w W 0x0 "Data signal of curr_layer_in_in_w" {{0 32 curr_layer_in_in_w W 0 "Bit 31 to 0 Data signal of curr_layer_in_in_w"}}} {0x38 curr_layer_in_in_h W 0x0 "Data signal of curr_layer_in_in_h" {{0 32 curr_layer_in_in_h W 0 "Bit 31 to 0 Data signal of curr_layer_in_in_h"}}} {0x40 curr_layer_in_out_w W 0x0 "Data signal of curr_layer_in_out_w" {{0 32 curr_layer_in_out_w W 0 "Bit 31 to 0 Data signal of curr_layer_in_out_w"}}} {0x48 curr_layer_in_out_h W 0x0 "Data signal of curr_layer_in_out_h" {{0 32 curr_layer_in_out_h W 0 "Bit 31 to 0 Data signal of curr_layer_in_out_h"}}} {0x50 curr_layer_in_in_ch W 0x0 "Data signal of curr_layer_in_in_ch" {{0 32 curr_layer_in_in_ch W 0 "Bit 31 to 0 Data signal of curr_layer_in_in_ch"}}} {0x58 curr_layer_in_out_ch W 0x0 "Data signal of curr_layer_in_out_ch" {{0 32 curr_layer_in_out_ch W 0 "Bit 31 to 0 Data signal of curr_layer_in_out_ch"}}} {0x60 curr_layer_in_ker_w W 0x0 "Data signal of curr_layer_in_ker_w" {{0 32 curr_layer_in_ker_w W 0 "Bit 31 to 0 Data signal of curr_layer_in_ker_w"}}} {0x68 curr_layer_in_ker_h W 0x0 "Data signal of curr_layer_in_ker_h" {{0 32 curr_layer_in_ker_h W 0 "Bit 31 to 0 Data signal of curr_layer_in_ker_h"}}} {0x70 curr_layer_in_ker_ch W 0x0 "Data signal of curr_layer_in_ker_ch" {{0 32 curr_layer_in_ker_ch W 0 "Bit 31 to 0 Data signal of curr_layer_in_ker_ch"}}} {0x78 curr_layer_in_str_w W 0x0 "Data signal of curr_layer_in_str_w" {{0 32 curr_layer_in_str_w W 0 "Bit 31 to 0 Data signal of curr_layer_in_str_w"}}} {0x80 curr_layer_in_str_h W 0x0 "Data signal of curr_layer_in_str_h" {{0 32 curr_layer_in_str_h W 0 "Bit 31 to 0 Data signal of curr_layer_in_str_h"}}} {0x88 curr_layer_in_pad_w W 0x0 "Data signal of curr_layer_in_pad_w" {{0 32 curr_layer_in_pad_w W 0 "Bit 31 to 0 Data signal of curr_layer_in_pad_w"}}} {0x90 curr_layer_in_pad_h W 0x0 "Data signal of curr_layer_in_pad_h" {{0 32 curr_layer_in_pad_h W 0 "Bit 31 to 0 Data signal of curr_layer_in_pad_h"}}} {0x98 curr_layer_in_relu W 0x0 "Data signal of curr_layer_in_relu" {{0 32 curr_layer_in_relu W 0 "Bit 31 to 0 Data signal of curr_layer_in_relu"}}} {0xa0 curr_layer_in_has_bias W 0x0 "Data signal of curr_layer_in_has_bias" {{0 32 curr_layer_in_has_bias W 0 "Bit 31 to 0 Data signal of curr_layer_in_has_bias"}}} {0xa8 curr_layer_in_act_type W 0x0 "Data signal of curr_layer_in_act_type" {{0 4 curr_layer_in_act_type W 0 "Bit 3 to 0 Data signal of curr_layer_in_act_type"} {4 28 RESERVED R 0 "Reserved.  0s on read."}}} {0xb0 input_offset W 0x0 "Data signal of input_offset" {{0 32 input_offset W 0 "Bit 31 to 0 Data signal of input_offset"}}} {0xb8 weights_offset W 0x0 "Data signal of weights_offset" {{0 32 weights_offset W 0 "Bit 31 to 0 Data signal of weights_offset"}}} {0xc0 output_offset W 0x0 "Data signal of output_offset" {{0 32 output_offset W 0 "Bit 31 to 0 Data signal of output_offset"}}} {0xc8 quantized_multiplier W 0x0 "Data signal of quantized_multiplier" {{0 32 quantized_multiplier W 0 "Bit 31 to 0 Data signal of quantized_multiplier"}}} {0xd0 right_shift W 0x0 "Data signal of right_shift" {{0 32 right_shift W 0 "Bit 31 to 0 Data signal of right_shift"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 81159900 II x}
...
set enable_xo_gen 0
set kernel_files {/home/studio/Prova_casa/src/zhang_convolution_ping_pong_prova_sintetica.c}
if {$enable_xo_gen} {
