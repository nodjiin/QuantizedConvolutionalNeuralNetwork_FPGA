...
module zhang_cnn_dataflow_in_loop_ti_loop_inputfm_V
#(parameter
    DataWidth    = 16,
    AddressRange = 32,
    AddressWidth = 12,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        zhang_cnn_dataflow_in_loop_ti_loop_inputfm_V_memcore zhang_cnn_dataflow_in_loop_ti_loop_inputfm_V_memcore_U (
            .clk      ( clk ),
            .reset    ( reset ),
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
